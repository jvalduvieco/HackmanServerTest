...
%% gen_fsm
-export([init/1, waiting_connect/2, waiting_login/2, handle_event/3, state_name/3, waiting_create_match/2,waiting_new_player/2, waiting_start_match/2, playing/2,
